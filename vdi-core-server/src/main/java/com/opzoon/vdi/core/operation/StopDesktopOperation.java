...
public class StopDesktopOperation implements Operation
{
  ...
  public StopDesktopOperation(int desktoppoolid, int cloudmanagerid, int desktopid, String vmid)
  {
  ...
  public Object execute(OperationContext operationContext) throws CommonException
  {
    ...
    operationContext.getOperationRegistry().start(new AsyncStopDesktopOperation(cloudmanagerid, desktopid, vmid));
    return null;
  }
  ...
  public boolean equals(Object object)
  {
    ...
    final StopDesktopOperation that = (StopDesktopOperation) object;
