...
import com.opzoon.vdi.core.util.LoggableInputStream;
import com.opzoon.vdi.core.util.LoggableOutputStream;

/**
 * $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
 * 
 * 这是来自开源的Jackson项目(1.9.9)的源码, 原文件为org\codehaus\jackson\jaxrs\JacksonJsonProvider.java.
 * 搜索"Evan"来查找修改过的地方.
 * 引用此类的地方请见spring-cxf.xml.
 * 
 * 改动:
 * 1 原代码不支持VDICore自定义的Content-Type, 对此进行了修改;
 * 2 原代码默认不省略空值(null), 对此进行了修改.
 * 
 * $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
 * 
 ...
 */
@Provider
// Evan 将application/json修改为application/opzoon-v4+json
@Produces(value={"application/opzoon-v4+json"})
// Evan 将application/json修改为application/opzoon-v4+json
@Consumes(value={"application/opzoon-v4+json"})
        ...
        Versioned // since 1.6
{
    ...
    public JacksonJsonProvider(ObjectMapper mapper, Annotations[] annotationsToUse)
    {
        ...
        // Evan 默认省略值为空的对象.
        _mapperConfig.getDefaultMapper().setSerializationInclusion(Inclusion.NON_NULL);
    }
    ...
    {
        ObjectMapper mapper = locateMapper(type, mediaType);
        JsonParser jp = mapper.getJsonFactory().createJsonParser(new LoggableInputStream(entityStream));
        ...
        throws IOException
    {
        ...
        JsonGenerator jg = mapper.getJsonFactory().createJsonGenerator(new LoggableOutputStream(entityStream), enc);
