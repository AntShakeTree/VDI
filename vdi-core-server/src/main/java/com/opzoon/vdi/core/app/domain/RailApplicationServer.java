 ...
 */
@Entity
@Table(name = "railapplicationserver")
public class RailApplicationServer implements Serializable, Comparable<RailApplicationServer> {
	...
	*/
	...
	public int compareTo(RailApplicationServer o) {
