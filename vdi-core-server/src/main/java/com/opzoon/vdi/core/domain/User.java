...
/**
 * 所有可以访问系统的用户, 不区分普通用户或管理员. 系统默认存在一个ID为0的管理员, 是第一个全局管理员.
 */
...
public class User implements Serializable {
  ...
  private Set<RSAKey> rsakeys;
	...
	/**
	 * @return 用户类型. 参考{@link Domain#DOMAIN_TYPE_LOCAL}, {@link Domain#DOMAIN_TYPE_MSAD}, {@link Domain#DOMAIN_TYPE_APACHE}.
	 */
