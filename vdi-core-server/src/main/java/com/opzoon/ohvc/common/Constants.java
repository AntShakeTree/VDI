...
public class Constants {
	...
	public static final String VDI_OPZOONCLOUD_TEMPS_URL = ConfigUtil
			.getBykey("vdi.opzooncloud.temps.url");
	...
	public static final String VDI_OPZOONCLOUD_TEMP_URI = ConfigUtil
	.getBykey("vdi.opzooncloud.temp.uri");
	...
	public static final String WAITING_TIMEOUT = "120";
	public static final String LIST_NODE_URL =  ConfigUtil.getBykey("");;
	public static int AGENT_BASE_SUCCESS=0x01010000;
	public static int DRVIER_SUCCESS=0x01022000;
	public static String NODES_SEED="node_seed";
	/**
	 * 不允许实例化
	 */
	private Constants() {
	 ...
	 */
	public static String formatURL(String src, String ip) {
		return MessageFormat.format(src, ip);
	}
}
